...
var EvolutionRPC = function (opts) {
  opts = opts || {}
  if (!(this instanceof EvolutionRPC)) return new EvolutionRPC(opts)
  this.host = opts.host || '127.0.0.1'
  this.port = opts.port || 22100
  this.timeout = opts.timeout || 2000
  this.ssl = opts.ssl || false
}

EvolutionRPC.prototype.getBlocks = function (opts) {
...
EvolutionRPC.prototype.getBlock = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
EvolutionRPC.prototype.getTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.hash) return reject(new Error('must specify hash'))
...
EvolutionRPC.prototype.getTransactionPool = function () {
  return new Promise((resolve, reject) => {
...
EvolutionRPC.prototype.getBlockCount = function () {
  return new Promise((resolve, reject) => {
...
EvolutionRPC.prototype.getBlockHash = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.height) return reject(new Error('must specify height'))
...
EvolutionRPC.prototype.getBlockTemplate = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
EvolutionRPC.prototype.submitBlock = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
EvolutionRPC.prototype.getLastBlockHeader = function () {
  return new Promise((resolve, reject) => {
...
EvolutionRPC.prototype.getBlockHeaderByHash = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.hash) return reject(new Error('must specify hash'))
...
EvolutionRPC.prototype.getBlockHeaderByHeight = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.height) return reject(new Error('must specify height'))
...
EvolutionRPC.prototype.getCurrencyId = function () {
  return new Promise((resolve, reject) => {
...
EvolutionRPC.prototype.getHeight = function () {
  return this.height()
}

EvolutionRPC.prototype.height = function () {
  return new Promise((resolve, reject) => {
...
EvolutionRPC.prototype.getInfo = function () {
  return this.info()
}

EvolutionRPC.prototype.info = function () {
  return new Promise((resolve, reject) => {
...
EvolutionRPC.prototype.feeInfo = function () {
  return this.fee()
}

EvolutionRPC.prototype.fee = function () {
  return new Promise((resolve, reject) => {
...
EvolutionRPC.prototype.getTransactions = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
EvolutionRPC.prototype.getPeers = function () {
  return this.peers()
}

EvolutionRPC.prototype.peers = function () {
  return new Promise((resolve, reject) => {
...
EvolutionRPC.prototype.sendRawTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
EvolutionRPC.prototype.getWalletSyncData = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
EvolutionRPC.prototype.getGlobalIndexesForRange = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
EvolutionRPC.prototype.getTransactionsStatus = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
EvolutionRPC.prototype.getBlocks = function (opts) { // getblocks
...
EvolutionRPC.prototype.queryBlocks = function (opts) { // queryblocks
  // *first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and so on, and the last one is always genesis block */
  return new Promise((resolve, reject) => {
    return reject(new Error('This RPC call is not implemented'))
  })
...
EvolutionRPC.prototype.queryBlocksDetailed = function (opts) {
  // *first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and so on, and the last one is always genesis block */
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
EvolutionRPC.prototype.queryBlocksLite = function (opts) {
  // *first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and so on, and the last one is always genesis block */
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!Array.isArray(opts.blockHashes)) return reject(new Error('must supply an array of block hashes'))
...
EvolutionRPC.prototype.getIndexes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
EvolutionRPC.prototype.getRandomOutputs = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
EvolutionRPC.prototype.getPoolChanges = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
EvolutionRPC.prototype.getPoolChangesLite = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (opts.tailBlockHash === undefined) return reject(new Error('must supply a tail block hash'))
    if (!Array.isArray(opts.knownTransactionHashes)) return reject(new Error('must supply an array of known transaction hashes'))
...
EvolutionRPC.prototype.getBlockDetailsByHeight = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
EvolutionRPC.prototype.getBlocksDetailsByHeights = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
EvolutionRPC.prototype.getBlocksDetailsByHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!Array.isArray(opts.blockHashes)) return reject(new Error('must supply an array of block hashes'))
...
EvolutionRPC.prototype.getBlocksHashesByTimestamps = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
EvolutionRPC.prototype.getTransactionDetailsByHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
EvolutionRPC.prototype.getTransactionHashesByPaymentId = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
EvolutionRPC.prototype._get = function (method) {
  return new Promise((resolve, reject) => {
...
EvolutionRPC.prototype._post = function (method, params) {
  return new Promise((resolve, reject) => {
    if (method.length === 0) return reject(new Error('no method supplied'))
    params = params || {}
...
EvolutionRPC.prototype._rawPost = function (endpoint, body) {
  return new Promise((resolve, reject) => {
